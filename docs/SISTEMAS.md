...
| Hechos/sanciones/resoluciones (entidad y globales) | www.cmfchile.cl | 6 |
...
| Documentos firmados (ver_sgd) | www.cmfchile.cl | 2 |
| Bancos (tasas, cronología, BaseDato) | tasas/cronologiabancaria.cmfchile.cl | 3 |
| **Paquetes de alto nivel** (plan empresa, documentos ZIP, boletines FM, catálogo completo) | www.cmfchile.cl | 4 (ver `PAQUETES.md`) |
...
- **Captchas**: hechos globales y cartola diaria exigen captcha (se resuelve con el usuario vía MRTR). Nunca OCR automático.
...
- **Caducidad**: catálogos grandes (11.401 entidades, 3.400 fondos) se cachean 24h en KV y se sirven paginados.
